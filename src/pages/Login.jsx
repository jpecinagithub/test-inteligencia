      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-blue-600 to-indigo-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold text-white mb-4">
            Evalúa tu inteligencia en minutos
          </h1>
          <p className="text-lg text-white/80 leading-relaxed">
            Accede a tu cuenta y descubre tu coeficiente intelectual, 
            fortalezas cognitivas y áreas de mejora.
          </p>
          ...
          <div className="mt-10 space-y-4">
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4">
              ...
              <div>
                <div className="text-white font-medium">Resultados instantáneos</div>
                <div className="text-white/60 text-sm">Conoce tu puntuación al instante</div>
              </div>
            </div>
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4">
            ...
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4">
              <div className="w-10 h-10 bg-alert/30 rounded-lg flex items-center justify-center">
                <svg className="w-5 h-5 text-alert" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <div className="text-white font-medium">Recibe tu informe por email</div>
                <div className="text-white/60 text-sm">Resultados detallados en tu bandeja</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-primary hover:text-blue-400 text-sm transition-colors">
